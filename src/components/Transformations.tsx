    ...
    <section className="bg-[#050505] px-4 py-16 sm:px-8 sm:py-24 lg:px-10 lg:py-32">
      <div className="mx-auto max-w-7xl">
        <SectionHeader
          ...
          description="Este bloco esta pronto para receber fotos reais do marketing: antes e depois, evolucao fisica, performance e consistencia."
        />
        <div className="grid gap-4 md:grid-cols-3">
          {transformations.map((item, index) => (
            <motion.article
              ...
              className="group relative min-h-[310px] overflow-hidden rounded-md border border-white/10 bg-zinc-950 shadow-[0_24px_80px_rgba(0,0,0,0.28)] sm:min-h-[420px]"
            >
              <img
                src={item.image}
                alt={item.label}
